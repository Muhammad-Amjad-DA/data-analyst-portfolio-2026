...
**Recommendation 2:** Offer an incentivized upgrade from month-to-month to a one-year or two-year plan during onboarding, since contract type alone separates a 66.7% churn segment from a 0% churn segment.
